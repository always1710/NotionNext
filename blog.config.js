...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || 'fcdcc353a15143acaa454a0727f20fd3',  // https://angry-desert-4f1.notion.site/fcdcc353a15143acaa454a0727f20fd3?v=a5c723d274bf4d31bc32a3c21cb612e3&pvs=4
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到我的博客🎉',  // Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xylia', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://xylia.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'always1710@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/always1710', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PATH:
      'https://npm.elemecdn.com/prism-themes/themes/prism-atom-dark.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes    prism-a11y-dark.min.css
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Xylia', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译   NotionNext BLOG
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '', // 站点描述，被notion中的页面描述覆盖  这是一个由NotionNext生成的站点
